...
class GoogleReviewBot:
    ...
    def initialize(self):
        ...
        self.driver.get("https://accounts.google.com/signin/v2/identifier?hl=tr&passive=true&continue=https%3A%2F%2Fwww.google.com%2Fsearch%3Fq%3Dgoogle%26oq%3Dgoogle%26aqs%3Dchrome.0.69i59l3j0i271l2j69i60j69i65j69i60.706j0j1%26sourceid%3Dchrome%26ie%3DUTF-8&ec=GAZAAQ&flowName=GlifWebSignIn&flowEntry=ServiceLogin")
    ...
    def GetUserInfo(mailaddressFile,passwordsFile,commentsFile):
        MailAddress=pd.read_csv(mailaddressFile).sample(frac=1)
        Password=pd.read_csv(passwordsFile).sample(frac=1)
        Comment=pd.read_csv(commentsFile).sample(frac=1)
